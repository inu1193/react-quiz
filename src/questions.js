export default [
  ...
  {
    id: 'q9',
    text: 'What is a "key" in React, and why is it important?',
    answers: [
      'A special string attribute used to track elements in a list and manage their reordering.',
      'An identifier used for styling elements dynamically.',
      'A unique identifier for each React component in a project.',
      'A method to pass data between parent and child components.',
    ],
  },
  {
    id: 'q10',
    text: 'What does the Context API in React help you achieve?',
    answers: [
      'It enables sharing state globally without passing props manually at every level.',
      'It allows creating custom hooks for a React application.',
      'It simplifies the use of lifecycle methods in functional components.',
      'It replaces Redux for managing global state completely.',
    ],
  },
];
